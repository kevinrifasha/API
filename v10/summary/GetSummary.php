...
echo json_encode(["success"=>$success, "status"=>$status,"msg"=>$msg, "data"=>$res, "total"=>$totalVisits, "deals"=>$resDeal, "totalDeal"=>$totalDeal, "package"=>$resPackage,"visits"=>$data,"totalVisits"=>$totalVisits,"totalPackage"=>$totalPackage, "pos"=>$resPOS, "totalPOS"=>$totalPOS]);
