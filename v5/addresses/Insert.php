...
if(isset($tokenValidate['success']) && $tokenValidate['success']==0){
    ...
    if(
        ...
        $q = mysqli_query($db_conn, "INSERT INTO `addresses` SET phone='$token->phone', name='$obj->name', recipient_name='$obj->recipientName', recipient_phone='$obj->recipientPhone', address='$obj->address', note='$obj->note', latitude='$obj->latitude', longitude='$obj->longitude', is_primary='$obj->isPrimary', shipper_location='$shipperLocation'");
