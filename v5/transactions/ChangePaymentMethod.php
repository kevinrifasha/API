            ...
            foreach ($trasactionID as $value) {
                if(!empty($value)){
                    ...
                    $il=0;
                        ...
                        if($paymentMethod==1 || $paymentMethod=="1" || $paymentMethod==2 || $paymentMethod=="2" || $paymentMethod==3 || $paymentMethod=="3" || $paymentMethod==4 || $paymentMethod=="4" || $paymentMethod==10 || $paymentMethod=="10" || $paymentMethod==14 || $paymentMethod=="14"){
