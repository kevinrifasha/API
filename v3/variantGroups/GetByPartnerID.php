...
foreach ($headers as $header => $value) {
    ...
    $status = $tokens['status'];
        ...
        $res = array();
        $sqlGetVarGroup = mysqli_query($db_conn, "SELECT * FROM `variant_group` WHERE (partner_id = '$partnerID' AND id_master = '$masterID') OR (partner_id = '' AND id_master = '$masterID') ");
