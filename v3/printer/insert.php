...
if(isset($tokens['success']) && $tokens['success']=='0' || isset($tokens['success']) && $tokens['success']==0){
    ...
    if(
        ...
        $printer = new Printer(array("id"=>0,"ip"=>$obj['ip'],"partnerId"=>$obj['partnerId'],"name"=>str_replace("'","''",$obj["name"]), "isReceipt"=>$obj['isReceipt'], "isFullChecker"=>$obj['isFullChecker'], "isCategoryChecker"=>$obj['isCategoryChecker'] ));
        $insert = $printerManager->add($printer);
