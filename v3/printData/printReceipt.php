...
$tokens = $tokenizer->validate($token);
    ...
    $status = $tokens['status'];
        ...
        $ipReceipt = $partner->getIp_receipt();
        ...
        foreach ($transactionDetails as $value) {
            ...
            $res1[$i]['harga_satuan'] = $value->getHarga_satuan();
        ...
        $j = 0;
        $checker=$res;
        $checker['ip_address']=substr($ipReceipt,2);
        ...
        foreach ($res1 as $value) {
            ...
            $checker['menu'][$j]['harga_satuan']=$value['harga_satuan'];
