...
echo json_encode(["success"=>$success, "status"=>$status,"msg"=>$msg, "service_percentage"=>$avgService, "totalBeforeService"=>$totalBeforeService, "service"=>$service]);
