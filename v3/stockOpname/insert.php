...
if(isset($tokens['success']) && $tokens['success']=='0' || isset($tokens['success']) && $tokens['success']==0){
    ...
    $poNo = $obj['poNo'];
    $total = $obj['total'];
        $sql = mysqli_query($db_conn, "INSERT INTO `purchase_orders`(`master_id`, `partner_id`, `supplier_id`, `total`, `created_at`, `created_by`, `no`) VALUES ('$tokenDecoded->masterID', '$tokenDecoded->partnerID', '$supplier_id', '$total', NOW(), '$tokenDecoded->id', '$poNo')");
        if($sql){
    ...
    $signupJson = json_encode(["msg"=>$signupMsg, "status"=>$status,"success"=>$success, "idInsert"=>$idInsert]);
