...
if(isset($tokens['success']) && $tokens['success']=='0' || isset($tokens['success']) && $tokens['success']==0){
    ...
    $sql = mysqli_query($db_conn, "INSERT INTO `attendance_patterns` SET name='$obj->name', partner_id='$obj->partnerID', master_id='$tokenDecoded->masterID',".$monday.",".$tuesday.",".$wednesday.",".$thursday.",".$friday.",".$saturday.",".$sunday);
