...
if ($event == "qr.payment") {
    ...
    if (
        ...
        $insertOST = mysqli_query(
            $db_conn,
            "INSERT INTO `order_status_trackings`(`transaction_id`, `status_before`, `status_after`, `payment_method_before`, `payment_method_after`) VALUES ('$external_id', '$tStatus', '$status', '$tipe_bayar' , '14')"
        ); 
