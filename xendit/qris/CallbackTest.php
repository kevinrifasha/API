...
if ($event == "qr.payment") {
    ...
    if (
        ...
        $test = "INSERT INTO `order_status_trackings`(`transaction_id`, `status_before`, `status_after`, `payment_method_before`, `payment_method_after`) VALUES ('$external_id', '$tStatus', '$status', '$payment_method' , '14')";
        ...
        $test1 = "INSERT INTO `order_status_trackings`(`transaction_id`, `status_before`, `status_after`) VALUES ('$external_id', '$tStatus', '0')";

        $insertOST = mysqli_query(
            $db_conn,
            "INSERT INTO `order_status_trackings`(`transaction_id`, `status_before`, `status_after`) VALUES ('$external_id', '$tStatus', '0')"
        );
