...
if(isset($tokenValidate['success']) && $tokenValidate['success']==0){
    ...
    $q = mysqli_query($db_conn, "SELECT m.id, ma.id AS masterID, ma.name AS owner_name, m.point, ma.name, ma.img FROM memberships m JOIN master ma ON ma.id = m.master_id WHERE m.user_phone = '$token->phone' AND ma.organization='Natta'");
