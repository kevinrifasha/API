            ...
            if (mysqli_num_rows($q) > 0) {
                ...
                if($bool==true){
                    if(isset($prerequisite->max) ){
                        if((int) $prerequisite->max < $tempPromo && (int) $prerequisite->max != 0){
