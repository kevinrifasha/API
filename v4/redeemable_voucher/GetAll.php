...
if(isset($tokenValidate['success']) && $tokenValidate['success']==0){
    ...
    $q = mysqli_query($db_conn, "SELECT v.id, v.code, v.title, v.description, v.type_id, v.is_percent, v.discount, v.enabled, v.valid_from, v.valid_until, v.total_usage, v.master_id, v.partner_id, v.img, vt.name, v.prerequisite FROM redeemable_voucher v JOIN voucher_types vt ON v.type_id=vt.id WHERE v.deleted_at IS NULL AND (v.master_id='$master_id' OR v.partner_id='$partner_id') ORDER BY v.id DESC");
