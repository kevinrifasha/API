...
if(isset($tokenValidate['success']) && $tokenValidate['success']==0){
    ...
    $today = date("Y-m-d");
    $gtotal = $_GET['total']??0;
    $qP = mysqli_query($db_conn,"SELECT `and_or`,`id`, `master_program_id`, `master_id`, `partner_id`, `title`, `minimum_value`, `menus`, categories, `enabled`, `valid_from`, `qty_redeem`, `valid_until`, `discount_type`,`discount_percentage`,`minimum_value`-'$gtotal' AS need_extra,
