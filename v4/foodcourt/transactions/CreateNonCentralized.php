        ...
        && !empty($data->paymentMethod) ){
            ...
            if($boolQty==true){
                ...
                $sql = "START TRANSACTION;";
                    if($paymentMethod=='11' || $paymentMethod==11){
                        $sql .= "INSERT INTO transaksi(`id`, `jam`, `phone`, `id_partner`, `no_meja`, `status`, `total`, `tipe_bayar`, `promo`, `point`, `queue`, `takeaway`, `notes`, `id_foodcourt`, `tax`, `service`, `charge_ewallet`, `charge_xendit`, `charge_ur`, `id_voucher`, `id_voucher_redeemable`, `diskon_spesial`, `shift_id`, `program_discount`, `program_id`, `customer_name`, `customer_email`, `is_pos`, `tenant_id`) VALUES ('$id', '$today', '$phone', '$partnerID', '$tableCode', '1', '$total', '$paymentMethod', '$promo', '$point', '$is_queue', '$is_takeaway', '$notes', '$foodcourtID', '$tax', '$service', '$charge_ewallet', '$charge_xendit', '$charge_ur', '$id_voucher', '$id_voucher_redeemable', '$diskon_spesial', '$shiftID', '$program_discount', '$program_id', '$customer_name', '$customer_email', '$is_pos', '$tenant_id'); ";
                    }else{
                        if($delivery_status_tracking=='1'){
                            $status='1';
                        }
                        $sql .= "INSERT INTO transaksi(`id`, `jam`, `paid_date`, `phone`, `id_partner`, `no_meja`, `status`, `total`, `tipe_bayar`, `promo`, `point`, `queue`, `takeaway`, `notes`, `id_foodcourt`, `tax`, `service`, `charge_ewallet`, `charge_xendit`, `charge_ur`, `id_voucher`, `id_voucher_redeemable`, `diskon_spesial`, `shift_id`, `program_discount`, `program_id`, `customer_name`, `customer_email`, `is_pos`, `tenant_id`) VALUES ('$id', '$today', '$today', '$phone', '$partnerID', '$tableCode', '1', '$total', '$paymentMethod', '$promo', '$point', '$is_queue', '$is_takeaway', '$notes', '$foodcourtID', '$tax', '$service', '$charge_ewallet', '$charge_xendit', '$charge_ur', '$id_voucher', '$id_voucher_redeemable', '$diskon_spesial', '$shiftID', '$program_discount', '$program_id', '$customer_name', '$customer_email', '$is_pos', '$tenant_id'); ";
                    }
