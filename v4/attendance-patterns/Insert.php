...
if(isset($tokenValidate['success']) && $tokenValidate['success']==0){
    ...
    $sql = mysqli_query($db_conn, "INSERT INTO `attendance_patterns` SET name='$obj->name', partner_id='$token->id_partner', master_id='$token->id_master',".$monday.",".$tuesday.",".$wednesday.",".$thursday.",".$friday.",".$saturday.",".$sunday);
