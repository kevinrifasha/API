...
class Token
{
  ...
  public function reCreate($tkn)
  {
    ...
    if ($checker["status"] == 403) {
      ...
      $tkn = json_encode(['id' => $tknDecrypt->id, 'role_id' => $tknDecrypt->role_id, 'id_master' => $tknDecrypt->id_master, 'id_partner' => $tknDecrypt->id_partner, 'created_at' => $today, 'expired' => 30000]);
    }
