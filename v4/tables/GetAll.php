...
//     }
//     $q = mysqli_query($db_conn, "SELECT `id`, `idmeja`, `is_queue` FROM `meja` WHERE idpartner='$id_partner' AND deleted_at IS NULL order by (idmeja regexp '^[A-Z]') desc, (case when idmeja regexp '^[A-Z]' then left(idmeja, 1) end), 
//          length(idmeja) asc,
//          idmeja");
