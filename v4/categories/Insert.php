...
if(isset($tokenValidate['success']) && $tokenValidate['success']==0){
    ...
    if(
        ...
        $insert = mysqli_query($db_conn,"INSERT INTO `categories`(`id_master`, `name`, `sequence`, `created_at`, `department_id`) VALUES ('$token->id_master', '$obj->name', '$obj->sequence', NOW(), '$obj->department_id')");
        if($insert){
