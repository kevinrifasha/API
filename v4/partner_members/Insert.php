...
if(isset($tokenValidate['success']) && $tokenValidate['success']==0){
    ...
    if(
       ...
       if(mysqli_num_rows($validate)>0 ){
            ...
            $validate1 = mysqli_query($db_conn, "SELECT phone FROM memberships WHERE phone='$data->phone' AND id_master='$token->id_master' AND deleted_at IS NULL");
            if(mysqli_num_rows($validate1)==0){
                $insert = mysqli_query($db_conn,"INSERT INTO memberships SET phone='$data->phone', max_disc='$data->max_disc', id_master='$token->id_master'");
                if($insert){
