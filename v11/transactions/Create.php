    ...
    if (
        ...
        if ($boolQty == true) {
            ...
            if (isset($data->group_id) && !empty($data->group_id)) {
                ...
                if ($paymentMethod == '11') {
                    $sql .= "INSERT INTO transaksi(id, jam, phone, id_partner, no_meja, status, total, tipe_bayar, promo, point, queue, takeaway, notes, id_foodcourt, tax, service, charge_ewallet, charge_xendit, charge_ur, id_voucher, id_voucher_redeemable, diskon_spesial, customer_name, reference_id, group_id, shift_id, employee_discount, surcharge_id, surcharge_percent, customer_email, is_pos, cpm_id, pax, employee_discount_percent, rounding, program_discount,organization) VALUES ('$id', '$today', '$phone', '$partnerID', '$tableCode', '$status', '$total', '$paymentMethod', '$promo', '$point', '$is_queue', '$is_takeaway', '$notes', '$foodcourtID', '$tax', '$service', '$charge_ewallet', '$charge_xendit', '$charge_ur', '$id_voucher', '$id_voucher_redeemable', '$diskon_spesial', '$name', '$reference_id', $group_id, '$shiftID', '$employee_discount', '$surcharge_id', '$surcharge_percent', '$customer_email', '$is_pos', '$cpm_id','$pax','$employee_discount_percent', '$rounding', '$program_discount','Natta'); ";
                } else if ($paymentMethod == '12') {
                    $status = '7';
                    $sql .= "INSERT INTO transaksi(id, jam,  phone, id_partner, no_meja, status, total, tipe_bayar, promo, point, queue, takeaway, notes, id_foodcourt, tax, service, charge_ewallet, charge_xendit, charge_ur, id_voucher, id_voucher_redeemable, diskon_spesial, customer_name, reference_id, group_id, shift_id, employee_discount, surcharge_id, surcharge_percent, customer_email, is_pos, cpm_id,pax, employee_discount_percent, is_ar, rounding, program_discount, organization) VALUES ('$id', '$today', '$phone', '$partnerID', '$tableCode', '$status', '$total', '$paymentMethod', '$promo', '$point', '$is_queue', '$is_takeaway', '$notes', '$foodcourtID', '$tax', '$service', '$charge_ewallet', '$charge_xendit', '$charge_ur', '$id_voucher', '$id_voucher_redeemable', '$diskon_spesial', '$name', '$reference_id', $group_id, '$shiftID', '$employee_discount', '$surcharge_id', '$surcharge_percent', '$customer_email', '$is_pos', '$cpm_id','$pax','$employee_discount_percent','1', $rounding, '$program_discount', 'Natta' ); ";
                } else if ($paymentMethod == '13') {
                    if ((int)$status == 2) {
                        $sql .= "INSERT INTO transaksi(id, jam,  phone, id_partner, no_meja, status, total, tipe_bayar, promo, point, queue, takeaway, notes, id_foodcourt, tax, service, charge_ewallet, charge_xendit, charge_ur, id_voucher, id_voucher_redeemable, diskon_spesial, customer_name, reference_id, group_id, shift_id, employee_discount, surcharge_id, surcharge_percent, customer_email, is_pos, cpm_id,pax, employee_discount_percent, dp_id, dp_total, paid_date, rounding, program_discount, collector_id, organization) VALUES ('$id', '$today', '$phone', '$partnerID', '$tableCode', '$status', '$total', '$data->remainingPM', '$promo', '$point', '$is_queue', '$is_takeaway', '$notes', '$foodcourtID', '$tax', '$service', '$charge_ewallet', '$charge_xendit', '$charge_ur', '$id_voucher', '$id_voucher_redeemable', '$diskon_spesial', '$name', '$reference_id', $group_id, '$shiftID', '$employee_discount', '$surcharge_id', '$surcharge_percent', '$customer_email', '$is_pos', '$cpm_id','$pax','$employee_discount_percent', '$data->dpID', '$data->dpTotal', NOW(), $rounding, '$program_discount', '$collector_id', 'Natta'); ";
                    } else {
                        $sql .= "INSERT INTO transaksi(id, jam,  phone, id_partner, no_meja, status, total, tipe_bayar, promo, point, queue, takeaway, notes, id_foodcourt, tax, service, charge_ewallet, charge_xendit, charge_ur, id_voucher, id_voucher_redeemable, diskon_spesial, customer_name, reference_id, group_id, shift_id, employee_discount, surcharge_id, surcharge_percent, customer_email, is_pos, cpm_id,pax, employee_discount_percent, dp_id, dp_total, rounding, program_discount, organization) VALUES ('$id', '$today', '$phone', '$partnerID', '$tableCode', '$status', '$total', '$data->remainingPM', '$promo', '$point', '$is_queue', '$is_takeaway', '$notes', '$foodcourtID', '$tax', '$service', '$charge_ewallet', '$charge_xendit', '$charge_ur', '$id_voucher', '$id_voucher_redeemable', '$diskon_spesial', '$name', '$reference_id', $group_id, '$shiftID', '$employee_discount', '$surcharge_id', '$surcharge_percent', '$customer_email', '$is_pos', '$cpm_id','$pax','$employee_discount_percent', '$data->dpID', '$data->dpTotal', $rounding, '$program_discount', 'Natta'); ";
                    }
                } else {
                    ...
                    if((int)$status == 2){
                        $sql .= "INSERT INTO transaksi(id, jam,  phone, id_partner, no_meja, status, total, tipe_bayar, promo, point, queue, takeaway, notes, id_foodcourt, tax, service, charge_ewallet, charge_xendit, charge_ur, id_voucher, id_voucher_redeemable, diskon_spesial, customer_name, reference_id, group_id, shift_id, employee_discount, surcharge_id, surcharge_percent, paid_date, customer_email, is_pos, cpm_id,pax, employee_discount_percent, rounding, program_discount, collector_id, organization ) VALUES ('$id', '$today', '$phone', '$partnerID', '$tableCode', '$status', '$total', '$paymentMethod', '$promo', '$point', '$is_queue', '$is_takeaway', '$notes', '$foodcourtID', '$tax', '$service', '$charge_ewallet', '$charge_xendit', '$charge_ur', '$id_voucher', '$id_voucher_redeemable', '$diskon_spesial', '$name', '$reference_id', $group_id, '$shiftID', '$employee_discount', '$surcharge_id', '$surcharge_percent', '$today', '$customer_email', '$is_pos', '$cpm_id','$pax','$employee_discount_percent',$rounding, '$program_discount','$collector_id', 'Natta'); ";
                    } else {
                        $sql .= "INSERT INTO transaksi(id, jam,  phone, id_partner, no_meja, status, total, tipe_bayar, promo, point, queue, takeaway, notes, id_foodcourt, tax, service, charge_ewallet, charge_xendit, charge_ur, id_voucher, id_voucher_redeemable, diskon_spesial, customer_name, reference_id, group_id, shift_id, employee_discount, surcharge_id, surcharge_percent, paid_date, customer_email, is_pos, cpm_id,pax, employee_discount_percent, rounding, program_discount, organization) VALUES ('$id', '$today', '$phone', '$partnerID', '$tableCode', '$status', '$total', '$paymentMethod', '$promo', '$point', '$is_queue', '$is_takeaway', '$notes', '$foodcourtID', '$tax', '$service', '$charge_ewallet', '$charge_xendit', '$charge_ur', '$id_voucher', '$id_voucher_redeemable', '$diskon_spesial', '$name', '$reference_id', $group_id, '$shiftID', '$employee_discount', '$surcharge_id', '$surcharge_percent', '$today', '$customer_email', '$is_pos', '$cpm_id','$pax','$employee_discount_percent',$rounding, '$program_discount', 'Natta'); ";
                    }
                }
            } else {
                if ($paymentMethod == '11') {
                    $sql .= "INSERT INTO transaksi(id, jam, phone, id_partner, no_meja, status, total, tipe_bayar, promo, point, queue, takeaway, notes, id_foodcourt, tax, service, charge_ewallet, charge_xendit, charge_ur, id_voucher, id_voucher_redeemable, diskon_spesial, customer_name, reference_id, shift_id, employee_discount, surcharge_id, surcharge_percent, customer_email, is_pos, cpm_id,pax, employee_discount_percent, rounding, program_discount, collector_id, organization) VALUES ('$id', '$today', '$phone', '$partnerID', '$tableCode', '$status', '$total', '$paymentMethod', '$promo', '$point', '$is_queue', '$is_takeaway', '$notes', '$foodcourtID', '$tax', '$service', '$charge_ewallet', '$charge_xendit', '$charge_ur', '$id_voucher', '$id_voucher_redeemable', '$diskon_spesial', '$name', '$reference_id', '$shiftID', '$employee_discount', '$surcharge_id', '$surcharge_percent', '$customer_email', '$is_pos', '$cpm_id','$pax','$employee_discount_percent', $rounding, '$program_discount', '$collector_id', 'Natta'); ";
                } else if ($paymentMethod == '12') {
                    $status = '7';
                    $sql .= "INSERT INTO transaksi(id, jam, phone, id_partner, no_meja, status, total, tipe_bayar, promo, point, queue, takeaway, notes, id_foodcourt, tax, service, charge_ewallet, charge_xendit, charge_ur, id_voucher, id_voucher_redeemable, diskon_spesial, customer_name, reference_id, shift_id, employee_discount, surcharge_id, surcharge_percent, customer_email, is_pos, cpm_id,pax, employee_discount_percent, is_ar, rounding,  program_discount, organization) VALUES ('$id', '$today', '$phone', '$partnerID', '$tableCode', '$status', '$total', '$paymentMethod', '$promo', '$point', '$is_queue', '$is_takeaway', '$notes', '$foodcourtID', '$tax', '$service', '$charge_ewallet', '$charge_xendit', '$charge_ur', '$id_voucher', '$id_voucher_redeemable', '$diskon_spesial', '$name', '$reference_id', '$shiftID', '$employee_discount', '$surcharge_id', '$surcharge_percent', '$customer_email', '$is_pos', '$cpm_id','$pax','$employee_discount_percent','1', $rounding, ' $program_discount', 'Natta'); ";
                } else if ($paymentMethod == '13') {
                    if ((int)$status == 2) {
                        $sql .= "INSERT INTO transaksi(id, jam,  phone, id_partner, no_meja, status, total, tipe_bayar, promo, point, queue, takeaway, notes, id_foodcourt, tax, service, charge_ewallet, charge_xendit, charge_ur, id_voucher, id_voucher_redeemable, diskon_spesial, customer_name, reference_id, shift_id, employee_discount, surcharge_id, surcharge_percent, customer_email, is_pos, cpm_id,pax, employee_discount_percent, dp_id, dp_total, paid_date, rounding, program_discount, collector_id, organization) VALUES ('$id', '$today', '$phone', '$partnerID', '$tableCode', '$status', '$total', '$data->remainingPM', '$promo', '$point', '$is_queue', '$is_takeaway', '$notes', '$foodcourtID', '$tax', '$service', '$charge_ewallet', '$charge_xendit', '$charge_ur', '$id_voucher', '$id_voucher_redeemable', '$diskon_spesial', '$name', '$reference_id', '$shiftID', '$employee_discount', '$surcharge_id', '$surcharge_percent', '$customer_email', '$is_pos', '$cpm_id','$pax','$employee_discount_percent', '$data->dpID', '$data->dpTotal', NOW(), $rounding, '$program_discount', '$collector_id', 'Natta'); ";
                    } else {
                        $sql .= "INSERT INTO transaksi(id, jam,  phone, id_partner, no_meja, status, total, tipe_bayar, promo, point, queue, takeaway, notes, id_foodcourt, tax, service, charge_ewallet, charge_xendit, charge_ur, id_voucher, id_voucher_redeemable, diskon_spesial, customer_name, reference_id, shift_id, employee_discount, surcharge_id, surcharge_percent, customer_email, is_pos, cpm_id,pax, employee_discount_percent, dp_id, dp_total, rounding, program_discount, organization) VALUES ('$id', '$today', '$phone', '$partnerID', '$tableCode', '$status', '$total', '$data->remainingPM', '$promo', '$point', '$is_queue', '$is_takeaway', '$notes', '$foodcourtID', '$tax', '$service', '$charge_ewallet', '$charge_xendit', '$charge_ur', '$id_voucher', '$id_voucher_redeemable', '$diskon_spesial', '$name', '$reference_id', '$shiftID', '$employee_discount', '$surcharge_id', '$surcharge_percent', '$customer_email', '$is_pos', '$cpm_id','$pax','$employee_discount_percent', '$data->dpID', '$data->dpTotal', $rounding,'$program_discount', 'Natta'); ";
                    }
                } else {
                    if ($delivery_status_tracking == '1') {
                        $status = '1';
                    ...
                    if((int)$status == 2){
                        $sql .= "INSERT INTO transaksi(id, jam, phone, id_partner, no_meja, status, total, tipe_bayar, promo, point, queue, takeaway, notes, id_foodcourt, tax, service, charge_ewallet, charge_xendit, charge_ur, id_voucher, id_voucher_redeemable, diskon_spesial, customer_name, reference_id, shift_id, employee_discount, surcharge_id, surcharge_percent, paid_date, customer_email, is_pos, cpm_id,pax, employee_discount_percent, rounding, program_discount, collector_id, organization) VALUES ('$id', '$today', '$phone', '$partnerID', '$tableCode', '$status', '$total', '$paymentMethod', '$promo', '$point', '$is_queue', '$is_takeaway', '$notes', '$foodcourtID', '$tax', '$service', '$charge_ewallet', '$charge_xendit', '$charge_ur', '$id_voucher', '$id_voucher_redeemable', '$diskon_spesial', '$name', '$reference_id', '$shiftID', '$employee_discount', '$surcharge_id', '$surcharge_percent', '$today', '$customer_email', '$is_pos', '$cpm_id','$pax','$employee_discount_percent', $rounding, '$program_discount', '$collector_id', 'Natta'); ";
                    }else {
                        $sql .= "INSERT INTO transaksi(id, jam, phone, id_partner, no_meja, status, total, tipe_bayar, promo, point, queue, takeaway, notes, id_foodcourt, tax, service, charge_ewallet, charge_xendit, charge_ur, id_voucher, id_voucher_redeemable, diskon_spesial, customer_name, reference_id, shift_id, employee_discount, surcharge_id, surcharge_percent, paid_date, customer_email, is_pos, cpm_id,pax, employee_discount_percent, rounding, program_discount, organization) VALUES ('$id', '$today', '$phone', '$partnerID', '$tableCode', '$status', '$total', '$paymentMethod', '$promo', '$point', '$is_queue', '$is_takeaway', '$notes', '$foodcourtID', '$tax', '$service', '$charge_ewallet', '$charge_xendit', '$charge_ur', '$id_voucher', '$id_voucher_redeemable', '$diskon_spesial', '$name', '$reference_id', '$shiftID', '$employee_discount', '$surcharge_id', '$surcharge_percent', '$today', '$customer_email', '$is_pos', '$cpm_id','$pax','$employee_discount_percent', $rounding, '$program_discount', 'Natta'); ";
                    }
                }
            }
            // if($insert){
                ...
                if($err == ""){
                    ...
                    if (isset($data->customer_email) && !empty($data->customer_email) && $status == '2' && $paymentMethod != '11' && $paymentMethod != 11 && $paymentMethod != 12 && $paymentMethod != "12") {
                        ...
                        if (filter_var($user_email, FILTER_VALIDATE_EMAIL)) {
                            $insertTe = mysqli_query($db_conn, "INSERT INTO `pending_email`(`email`, `partner_id`, `subject`, `body`, `created_at`) VALUES ('$user_email', '$partnerID', 'Natta E-Receipt', $template, NOW())");
                        }
                    }
