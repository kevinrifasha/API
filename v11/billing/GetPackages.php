...
if(isset($tokens['success']) && $tokens['success']=='0' || isset($tokens['success']) && $tokens['success']==0){
    ...
    $q = mysqli_query($db_conn, "SELECT id, is_addon, name, description, price, type FROM `subscription_packages` WHERE deleted_at IS NULL AND id > 1 AND is_addon = 0 AND type = '$cycle'");
