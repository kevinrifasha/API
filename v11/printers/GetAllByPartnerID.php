...
if(isset($tokenValidate['success']) && $tokenValidate['success']==0){
    ...
    $blCount=0;
    $lanCount=0;
    $q = mysqli_query($db_conn, "SELECT * FROM `printer` WHERE partnerId='$token->id_partner' AND deleted_at IS NULL");
    $res = array();
...
$signupJson = json_encode(["msg"=>$msg, "status"=>$status, "success"=>$success, "printers"=>$res, "blCount"=>$blCount, "lanCount"=>$lanCount]);  
