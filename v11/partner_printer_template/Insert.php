...
if(isset($tokenValidate['success']) && $tokenValidate['success']==0){
    ...
    if(isset($logo) && isset($name) && isset($address) && isset($city) && isset($state) && isset($zip) && isset($phone) && isset($website) && isset($twitter) && isset($website) && isset($facebook) && isset($instagram) && isset($notes) ){
