...
if(isset($tokenValidate['success']) && $tokenValidate['success']==0){
    ...
    $q = mysqli_query($db_conn,"SELECT r.id, r.id_menu, r.id_raw, r.qty, r.id_metric, r.id_variant, m.nama AS menuName, m.img_data AS menuImage,rw.name AS rawName, me.name AS metricName FROM recipe r JOIN menu m ON m.id=r.id_menu JOIN raw_material rw ON rw.id=r.id_raw JOIN metric me ON me.id=r.id_metric AND m.is_recipe='1' WHERE m.id_partner='{$token->id_partner}' ORDER BY r.id_menu");
