...
<html>
    ...
    <body style="margin: 100" align="center">
        ...
        <div class="container">
            <div class="card">
            <h3 style="padding-top:100px"> UR QUEUE</h3>
                ...
                {   
                    ...
                    if($ca == $today){
                        ...
                        if($temp == USER_UPDATED){
                            ...
                            echo "<script>if(confirm('Your Password Sucessfully Updated. Now Login')){document.location.href='http://queue.ur-hub.com'};</script>";
