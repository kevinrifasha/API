...
if ($http_origin == "http://localhost:3000" || $http_origin == "https://foodcourt.ur-hub.com" || $http_origin == "http://localhost:3001") {
...
$sql = "Select * from foodcourt where email='$email' and password='$password'";
