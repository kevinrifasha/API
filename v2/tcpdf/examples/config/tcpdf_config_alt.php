 ...
 */
define ('PDF_HEADER_LOGO', 'logo ur partner.jpg');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Laporan Keuangan');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "UR - PT. Rahmat Tuhan Lestari \nJl. Jend. Sudirman No.496, Ciroyom, Kec. Andir\nKota Bandung Jawa Barat 40221 \n(+62)87777-0-7777-1");
