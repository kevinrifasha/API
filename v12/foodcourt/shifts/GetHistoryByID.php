    ...
    if (mysqli_num_rows($q) > 0) {
        ...
        foreach ($res as $value) {
            ...
            // if($value['end']==null){
                ...
                $query = "SELECT t.*, pm.nama AS paymentName, t.paid_date AS finish_date FROM transaksi t JOIN payment_method pm ON pm.id=t.tipe_bayar  WHERE t.shift_id='$sID' AND t.organization='Natta' AND t.deleted_at IS NULL AND (t.status=1 OR t.status=2) ";
