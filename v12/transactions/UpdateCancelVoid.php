...
if(isset($tokens['success']) && $tokens['success']=='0' || isset($tokens['success']) && $tokens['success']==0){
    ...
    if(
        ...
        //transaction
        $qT = mysqli_query($db_conn, "SELECT * FROM `transaksi` WHERE id='$obj->transactionID' AND organization='Natta' AND (status!=3 || status!=4) ");
        ...
        $q = mysqli_query($db_conn,"SELECT id, id_partner, charge_ur, status, employee_discount_percent, id_voucher FROM `transaksi` WHERE id='$obj->transactionID' AND organization='Natta' AND diskon_spesial='0' AND program_discount='0'");
        $partner_id = '';
        $charge_ur = 0;
        $total = 0;
        $status = 0;
