...
$ch = curl_init();
if(isset($_GET['suburbId']) && !empty($_GET['suburbId'])){
    curl_setopt($ch, CURLOPT_URL, 'https://'.$_ENV['SHIPPER_URL'].'/public/v1/agents?apiKey='.$_ENV['SHIPPER_API_KEY'].'&suburbId='.$_GET['suburbId']);
