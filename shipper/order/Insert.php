...
if(
    isset($obj['origin']) && !empty($obj['origin'])
    && isset($obj['destination']) && !empty($obj['destination'])
    ...
    && isset($obj['price']) && !empty($obj['price'])
    ){
        $json = [
            "o"=> $obj['origin'],
            "d"=> $obj['destination'],
            ...
            "consigneePhoneNumber"=> $obj['consigneePhoneNumber'],
            "rateID"=> $obj['rateID'],
            "consignerName"=> $obj['consignerName'],
            "consignerPhoneNumber"=> $obj['consignerPhoneNumber'],
            "originAddress"=> $obj['originAddress'],
            "originDirection"=> $obj['originDirection'],
            "destinationAddress"=> $obj['destinationAddress'],
            "destinationDirection"=> $obj['destinationDirection'],
            "itemName"=> $obj['items'],
            "contents"=> $obj['contents'],
            "useInsurance"=> $obj['useInsurance'],
        ...
        if(isset($obj['cod']) && !empty($obj['cod'])){
            $url .= '&cod='.$obj['cod'];
        }
        if(isset($obj['order']) && !empty($obj['order'])){
            $url .= '&order='.$obj['order'];
        }
        if(isset($obj['origincoord']) && !empty($obj['origincoord'])){
            $url .= '&originCoord='.$obj['origincoord'];
        }
        if(isset($obj['destinationcoord']) && !empty($obj['destinationcoord'])){
            $url .= '&destinationCoord='.$obj['destinationcoord'];
        }
