...
//url api
$url = 'https://api.klikbca.com:443/banking/v3/corporates/KBBRAHMATT/accounts/'.$accounts.'/statements?EndDate='.$endDate.'&StartDate='.$startDate;
$relativeUrl = '/banking/v3/corporates/KBBRAHMATT/accounts/'.$accounts.'/statements?EndDate='.$endDate.'&StartDate='.$startDate;
