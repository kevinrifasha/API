...
if(isset($tokenValidate['success']) && $tokenValidate['success']==0){
    ...
    $map = mysqli_query($db_conn, "SELECT id,name,longitude, latitude,img_map,desc_map,phone, is_booked, booked_before,address FROM partner WHERE longitude <>'' AND is_testing='0' ");
