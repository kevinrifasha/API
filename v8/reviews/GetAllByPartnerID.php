...
$id = $_GET['id'];
$query = "SELECT r.id, r.review, r.rating, u.name,r.anonymous, r.created_at FROM reviews r JOIN transaksi t ON t.id = r.transaction_id JOIN users u ON t.phone = u.phone WHERE t.id_partner='$id' AND r.deleted_at IS NULL AND t.deleted_at IS NULL ORDER BY id DESC";
$res=[];
$replies=[];
$i=0;
